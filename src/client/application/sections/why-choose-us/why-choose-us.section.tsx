...
import { WhyChooseUsProps } from '@/client/infra/graphql/landing-page/models'
...
export function WhyChooseUs({
  ...
  return (
    <section className="pt-[4.5rem] md:pt-[6.9375rem] lg:pt-[9.375rem] pb-[13.1875rem] md:pb-[6.9375rem] lg:pb-[9.375rem] flex flex-col items-center w-full max-w-[1200px] m-[0_auto] px-4 md:px-8 xl:px-0">
